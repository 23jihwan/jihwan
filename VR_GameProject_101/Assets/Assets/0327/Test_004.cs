...
{
    public int hp = 180;            //변수 hp 선언 180값 입력 (public은 인스팩터 창에서 보이게 하기 위하여 사용)
    public Text hpText;
    public Text hpStatus;       //Hp 숫자 표시 UI
    void Update()
    {
        hpText.text = hp.ToString();        //hp 숫자 표시 tostring 은 정수를 문자열로 변환
        ...
        else if (hp >= 200)       //변수 hp 가 200 이상일때
        {
